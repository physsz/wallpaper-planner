...
window.tasksData = {
  ...
  appearance: {
    ...
    columns: {
      ...
      center: "300px",  // command center (today's tasks)
  ...
  dailyTasks: [
    ...
    { text: "Complete top 3 priority tasks", done: true  },
    { text: "Team standup meeting",          done: true  },
    { text: "Update project statuses",       done: true  },
    { text: "Prep tomorrow's agenda",        done: false },
  ],
  ...
  weekProjects: [
    { name: "Website Redesign",   start: 0, end: 2, color: "#4a90d9" },
    { name: "Client Proposal",    start: 1, end: 3, color: "#4a90d9" },
    { name: "Q1 Report Draft",    start: 1, end: 5, color: "#4a90d9" },
    { name: "Code Review Sprint", start: 2, end: 5, color: "#e8734a" },
    { name: "Deploy v2.0",        start: 3, end: 6, color: "#4a90d9" },
    { name: "Stakeholder Review", start: 5, end: 7, color: "#e84a5f" },
  ],
  ...
  twoWeekProjects: [
    ...
    { name: "Preparation II",         start: 1,  end: 5,  color: "#5ba85b" },
    { name: "Preparation Milestone",  start: 3,  end: 7,  color: "#4a90d9" },
    { name: "Preparation Milestones", start: 5,  end: 10, color: "#4a90d9" },
    { name: "Preparation Milestones", start: 7,  end: 12, color: "#4a90d9" },
    { name: "Preparation Milestone",  start: 9,  end: 14, color: "#4a90d9" },
  ],
